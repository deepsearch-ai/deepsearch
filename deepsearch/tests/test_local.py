...
class LocalDataSourceTest(unittest.TestCase):
    ...
    def test_add_data_image_directory_with_no_existing_files(self, mock_image_file, mock_listdir):
        ...
        assert vector_database.add.mock_calls == [
            mock.call(embeddings, ["test_directory/image1.jpg"], ids, metadata, MEDIA_TYPE.IMAGE),
            mock.call(embeddings, ["test_directory/image2.png"], ids, metadata, MEDIA_TYPE.IMAGE)]
    ...
    def test_add_data_image_directory_with_no_existing_files(self, mock_image_file, mock_listdir):
        ...
        self.local_data_source.add_data(directory, llms_config, vector_database)
        assert vector_database.add.mock_calls == [
            mock.call(embeddings, ["test_directory/image1.jpg"], ids, new_metadata_1, MEDIA_TYPE.IMAGE),
            mock.call(embeddings, ["test_directory/image2.png"], ids, new_metadata_2, MEDIA_TYPE.IMAGE)]

    @patch("os.listdir")
    @patch("PIL.Image.open")
    def test_add_data_image_directory_with_existing_files(self, mock_image_file, mock_listdir):
        # Create a mock image file
        mock_listdir.return_value = ['image1.jpg', 'image2.png']
        mock_image_file.return_value = mock.Mock()
        ...
        vector_database = mock.Mock()
        vector_database.get_existing_document_ids.return_value = ["test_directory/image2.png"]
        ...
        self.local_data_source.add_data(directory, llms_config, vector_database)
        assert vector_database.add.mock_calls == [
            mock.call(embeddings, ["test_directory/image1.jpg"], ids, new_metadata, MEDIA_TYPE.IMAGE)]
